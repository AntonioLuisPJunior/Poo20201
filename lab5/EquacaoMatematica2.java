...
public class EquacaoMatematica2 {
	...
	// v7
	public EquacaoMatematica2() {}

	// v7
	public EquacaoMatematica2(char codigoOperacao) {
		this.codigoOperacao = codigoOperacao;
	}

	// v7
	public EquacaoMatematica2(char codigoOperacao, double valorEsquerda, double valorDireita) {
		this(codigoOperacao);
		this.valorEsquerda = valorEsquerda;
		this.valorDireita = valorDireita;
	}
